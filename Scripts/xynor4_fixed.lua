...
local function CreateLoader()
    ...
    task.spawn(function()
        ...
        -- Pop-in con escala
        tweenSpring(containerScale, 0.6, { 
            Scale = 1
        }):Play()
...
-- Wait for internal loader animation to finish, then check saved key
task.spawn(function()
    -- Wait for the internal progress animation (approx 2.5s) + small buffer
    task.wait(3.2)
